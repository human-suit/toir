...
@Controller('testauto2')
export class TestAuto2Controller {

  constructor(private readonly service: TestAuto2Service) {}
  ...
  @Post()
  create(@Body() dto: CreateTestAuto2Dto) {
    return this.service.create(dto);
  }

  @Put(':id')
  @Patch(':id')
  update(@Param('id') id: string, @Body() dto: UpdateTestAuto2Dto) {
