...
@Controller('testauto4')
export class TestAuto4Controller {

  constructor(private readonly service: TestAuto4Service) {}
  ...
  @Post()
  create(@Body() dto: CreateTestAuto4Dto) {
    return this.service.create(dto);
  }

  @Put(':id')
  @Patch(':id')
  update(@Param('id') id: string, @Body() dto: UpdateTestAuto4Dto) {
